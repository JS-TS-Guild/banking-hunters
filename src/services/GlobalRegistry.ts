...
class GlobalRegistry {
  ...
  getAccountByAccountId(accountId: BankAccountId): BankAccount | undefined {
  ...
  getBankByAccountId(accounId: BankAccountId): Bank | undefined {
  ...
  // By Bank Id
  getBankByBankId(bankId: BankId): Bank | undefined {
